...
def pc_bet_form(type):
	bet_info = {
		...
		# 排列三组六复式
		10028: {'betnum': '0135$', 'betstr': '0135$3_2~4', 'lotteryid': 54},
		# 排列三组选和值
		10029: {'betnum': '2$', 'betstr': '2$4_1~2', 'lotteryid': 54},
	}
	return bet_info.get(type)

#传入数字与彩种对应关系
def num_for_lotteryid():
	lottery_title = {
		...
		'52':[10016,10017],
		'53':[10018,10019],
		'54':[10020,10021,10022,10023,10024,10025,10026,10027,10028,10029]
	}
